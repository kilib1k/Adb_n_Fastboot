...
### v5.2 (2026-07-25)
- ➕ **Добавлена вкладка прошивки MIUI/HyperOS** (с интеграцией miuirom.org, Бета)
- ➕ **Добавлена система конфигов**
- ➕ **Добавлена подсветка ошибок, предупреждений и успехов в консоли**
- ➕ **Добавлена настройка пути к Platform-tools** (для совместимости с `flash_all.bat` / `.sh`)
- ➕ **Добавлено сохранение геометрии окна и активной вкладки**
- ➕ **Добавлено автообновление нескольких файлов** (`AdbFastboot.py` + `localization.json` + `themes.json`)
- ➕ **Добавлено 8 новых ключей локализации** для системы обновлений
- 🔄 **Темы вынесены в `themes.json`** (16 тем: 8 оригинальных + 8 новых)
